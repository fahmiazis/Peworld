      ...
      {role === 1 ? (
        <View style={styles.parent}>
          ...
          <View style={styles.bottomComponent}>
                ...
                {user.portofolio.map((item, index) => (
                  <TouchableOpacity
                    ...
                    <Image
                      ...
                      source={{
                        uri: API_URL.concat(item.picture.picture.slice(0, 27)),
                      }}
                    />
                  </TouchableOpacity>
                ))}
            ...
            {buttonExperience && !buttonPortofolio && user.experience && (
              <>
        ...
        <View style={styles.parent}>
          ...
          <View style={styles.bottomComponent}>
                  ...
                  {portofolio.map((item, index) => (
                    <TouchableOpacity
                      ...
                      <Image
                        ...
                        source={{
                          uri: API_URL.concat(
                            item.picture.picture.slice(0, 27),
                          ),
                        }}
                      />
                    </TouchableOpacity>
            ...
            {buttonExperience && !buttonPortofolio && experience && (
              <>
